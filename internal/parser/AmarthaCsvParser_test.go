...
type TestAmarthaCsvParser_ParseArgs struct {
	Label         string
	Args          map[string]string
	CheckExpected func(txn model.Transaction) error
}

func TestAmarthaCsvParser_Parse(t *testing.T) {
	testCases := []TestAmarthaCsvParser_ParseArgs{{
		Label: "match id",
